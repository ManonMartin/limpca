...
The package is actually in its development stage and is available on GitHub at the url: <https://github.com/ManonMartin/LMWiRe>. It can be installed via the `remotes::install_github()` function. The package needs to be loaded afterwards.
