...
# ASCA/ASCA-E/APCA decomposition

ASCA/ASCA-E/APCA decomposition allow to represent the information from the effect matrices in a space of reduced dimensions. The function `lmwPcaEffects()` has a method argument to define which method to use.
