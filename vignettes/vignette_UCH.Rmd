...
The loadings are here represented on a line plot with the function `lmwLoading1dPlot()` to conveniently compare them with the original spectral profiles. 
...
resLoadASCA <- lmwLoading1dPlot(resASCA, 
                              effectNames = c("Hippurate", "Citrate","Time",
                                              "Hippurate:Time",
                                              "Hippurate+Time+Hippurate:Time"), 
                              axes = 1, xlab = "ppm")
