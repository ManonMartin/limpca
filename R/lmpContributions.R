...
lmpContributions <- function(resLmpPcaEffects, nPC = 5) {
  ...
  rownames(total_contrib_table) <- c(names(resLmpPcaEffects)[1:(neffect - 1)],
                                     "Residuals")
  ...
  rownames(effect_table) <- c(names(resLmpPcaEffects)[1:(neffect - 1)],
                              "Residuals")
  ...
  rownames(contrib_table) <- c(names(resLmpPcaEffects)[1:(neffect - 1)],
                               "Residuals")
  ...
  # Filling table
  for (i in 1:neffect) {
    contrib_table[i, 1:nPC] <- (effect_table[i, 1:nPC] *
  ...
  effect_name <- ModelAbbrev(c(names(resLmpPcaEffects)[1:(neffect - 1)],
                               "Residuals"))
