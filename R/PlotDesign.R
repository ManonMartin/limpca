...
#'   
#' # 2 factors
#' PlotDesign(data = df, x = "cyl", y = "vs",rows = NULL,
#'           cols = NULL)
#' # 3 factors
#' PlotDesign(data = df, x = "cyl", y = "vs",rows = c("am"),
#'           cols = NULL)
#' # 4 factors
#' PlotDesign(data = df, x = "cyl", y = "vs",rows = c("am"),
#'           cols = c("gear"))
#' # 5 factors
#' PlotDesign(data = df, x = "cyl", y = "vs",rows = c("am", "carb"),
#'           cols = c("gear"))
#'
#' PlotDesign(data = df, x = "cyl", y = "vs",rows = c("am", "carb"),
#'          cols = c("vs"))
...
#' ### UCH
#' data("UCH")
#' PlotDesign(data = UCH$design, x = "Hippurate", y = "Citrate",rows = "Day")
#'
#' @import ggplot2
#' @import dplyr
