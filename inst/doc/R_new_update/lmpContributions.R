#' @export UPDATE_lmpContributions
...
UPDATE_lmpContributions <- function(resLmpPcaEffects, nPC = 5) {
  ...
  for (i in 1:neffect) {
    iEffect <- listNames[i]
    effect_table[i, 1:nPC] <- round(resLmpPcaEffects[[iEffect]]$var[1:nPC], 2)
  }
  ...
  ##### update Antoine: condition in the if
